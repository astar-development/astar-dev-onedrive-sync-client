...
public sealed class AccountManagementViewModelShould : IDisposable
{
    ...
    public AccountManagementViewModelShould()
    {
        ...
        _ = _authService.LoginAsync(Arg.Any<CancellationToken>()).Returns(Task.FromResult<Result<AuthenticationResult, ErrorResponse>>(new Result<AuthenticationResult, ErrorResponse>.Ok(new AuthenticationResult(false, string.Empty, new HashedAccountId(string.Empty), string.Empty, "Not configured"))));
    ...
    public async Task AddAccountSuccessfully()
    {
        ...
        _ = _authService.LoginAsync(Arg.Any<CancellationToken>()).Returns(Task.FromResult<Result<AuthenticationResult, ErrorResponse>>(new Result<AuthenticationResult, ErrorResponse>.Ok(authResult)));
    ...
    public async Task ShowToastOnAddAccountFailure()
    {
        ...
        _ = _authService.LoginAsync(Arg.Any<CancellationToken>()).Returns(Task.FromResult<Result<AuthenticationResult, ErrorResponse>>(new Result<AuthenticationResult, ErrorResponse>.Error(new ErrorResponse(authResult.ErrorMessage!))));
    ...
    public async Task LogoutFromSelectedAccount()
    {
        ...
        _viewModel.Accounts.Add(account);
        _viewModel.SelectedAccount = account;
        _ = _authService.LogoutAsync("id1", Arg.Any<CancellationToken>()).Returns(Task.FromResult<Result<bool, ErrorResponse>>(new Result<bool, ErrorResponse>.Ok(true)));
    ...
    public async Task NotUpdateAccountOnLogoutFailure()
    {
        ...
        _viewModel.Accounts.Add(account);
        _viewModel.SelectedAccount = account;
        _ = _authService.LogoutAsync("id1", Arg.Any<CancellationToken>()).Returns(Task.FromResult<Result<bool, ErrorResponse>>(new Result<bool, ErrorResponse>.Error(new ErrorResponse("Logout failed"))));
    ...
    public async Task CancelPreviousToastWhenShowingNewToast()
    {
        ...
        _ = _authService.LoginAsync(Arg.Any<CancellationToken>()).Returns(Task.FromResult<Result<AuthenticationResult, ErrorResponse>>(new Result<AuthenticationResult, ErrorResponse>.Error(new ErrorResponse(authResult1.ErrorMessage!))));
