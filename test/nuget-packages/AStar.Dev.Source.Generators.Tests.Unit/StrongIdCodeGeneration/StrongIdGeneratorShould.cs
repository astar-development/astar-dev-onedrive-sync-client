...
public readonly partial record struct MyId(System.Guid Id)
{
    public static implicit operator System.Guid(MyId strongId) => strongId.Id;
    public static implicit operator MyId(System.Guid id) => new MyId(id);
}
