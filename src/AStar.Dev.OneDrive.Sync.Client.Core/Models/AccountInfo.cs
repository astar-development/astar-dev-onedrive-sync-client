...
public sealed record AccountInfo(string HashedAccountId, string DisplayName, string LocalSyncPath, bool IsAuthenticated, DateTimeOffset? LastSyncUtc, string? DeltaToken, bool EnableDetailedSyncLogging,
