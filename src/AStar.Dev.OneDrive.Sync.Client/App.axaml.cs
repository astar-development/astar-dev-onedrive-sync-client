...
public sealed class App : Application
{
    ...
    public override void OnFrameworkInitializationCompleted()
    {
        ...
        if(ApplicationLifetime is IClassicDesktopStyleApplicationLifetime desktop)
        {
            ...
            desktop.Startup += async (_, _) => await DebugLog.LogInfoAsync("App Startup", new Core.Models.HashedAccountId(AdminAccountMetadata.Id), "Application has started",CancellationToken.None);
