...
namespace AStar.Dev.OneDrive.Client.Migrations;
...
public partial class InitialCreation : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table => _ = table.PrimaryKey("PK_Accounts", x => x.AccountId));
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table => _ = table.PrimaryKey("PK_DebugLogs", x => x.Id));
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table => _ = table.PrimaryKey("PK_FileOperationLogs", x => x.Id));
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table => _ = table.PrimaryKey("PK_SyncSessionLogs", x => x.Id));
        ...
        _ = migrationBuilder.CreateTable(
            ...
            constraints: table => _ = table.PrimaryKey("PK_WindowPreferences", x => x.Id));
