...
public interface IRemoteChangeDetector
{
    ...
    /// </summary>
    /// <param name="accountId">The account identifier - required for calling the Graph API.</param>
    ...
    Task<(IReadOnlyList<FileMetadata> Changes, string? NewDeltaLink)> DetectChangesAsync(string accountId,
