...
public interface IFolderTreeService
{
    ...
    /// </remarks>
    Task<IReadOnlyList<OneDriveFolderNode>> GetRootFoldersAsync(string accountId, HashedAccountId hashedAccountId, CancellationToken cancellationToken = default);
    ...
    /// <param name="parentIsSelected">Indicates if the parent folder is selected.</param>
    /// <param name="cancellationToken">Optional cancellation token.</param>
    ...
    /// </remarks>
    Task<IReadOnlyList<OneDriveFolderNode>> GetChildFoldersAsync(string accountId, HashedAccountId hashedAccountId, string parentFolderId, bool? parentIsSelected = null, CancellationToken cancellationToken = default);
    ...
    /// </remarks>
    Task<IReadOnlyList<OneDriveFolderNode>> GetFolderHierarchyAsync(string accountId, HashedAccountId hashedAccountId, int? maxDepth = null, CancellationToken cancellationToken = default);
}
