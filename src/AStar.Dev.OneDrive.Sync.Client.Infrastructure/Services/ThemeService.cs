    ...
    private void ApplyThemeVariantAndResources(ThemePreference theme)
    {
        ...
        switch(theme)
        {
            ...
            case ThemePreference.Professional:
                Application.Current.RequestedThemeVariant = ThemeVariant.Default;
                LoadThemeResourceDictionary("avares://AStar.Dev.OneDrive.Sync.Client/Themes/ProfessionalTheme.axaml");
                break;

            case ThemePreference.Colourful:
                Application.Current.RequestedThemeVariant = ThemeVariant.Default;
                LoadThemeResourceDictionary("avares://AStar.Dev.OneDrive.Sync.Client/Themes/ColourfulTheme.axaml");
                break;

            case ThemePreference.Terminal:
                Application.Current.RequestedThemeVariant = ThemeVariant.Default;
                LoadThemeResourceDictionary("avares://AStar.Dev.OneDrive.Sync.Client/Themes/TerminalTheme.axaml");
                break;
        }
    }
