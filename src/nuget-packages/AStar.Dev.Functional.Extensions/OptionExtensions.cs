...
public static class OptionExtensions
{
    ...
    /// </summary>
    public static async Task<Result<T, TError>> ToResultAsync<T, TError>(this Task<Option<T>> optionTask, Func<TError> errorFactory)
    ...
    /// </summary>
    public static async Task<T> OrElseAsync<T>(this Option<T> option, Func<Task<T>> getFallbackAsync)
    ...
    public static TResult MapOrDefault<T, TResult>(this Option<T> option, Func<T, TResult> map, TResult defaultValue)
        => option.Match(some => map(some), () => defaultValue);
    ...
    public static TResult MapOrElse<T, TResult>(this Option<T> option, Func<T, TResult> map, Func<TResult> defaultFactory)
        => option.Match(some => map(some), defaultFactory);
}
